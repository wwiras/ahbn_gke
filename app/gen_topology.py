...
def main():
    ...
    trigger_time = float(failure_cfg.get("triggerTime", failure_cfg.get("trigger_time", 1.0)))
    overload_delay_ms = int(failure_cfg.get("overloadDelayMs", failure_cfg.get("overload_delay_ms", 200)))
    num_events = int(failure_cfg.get("numEvents", failure_cfg.get("num_events", 3)))
    interval_sec = float(failure_cfg.get("intervalSec", failure_cfg.get("interval_sec", 1.0)))
    target_type = str(failure_cfg.get("targetType", failure_cfg.get("target_type", "mixed")))

    workload_cfg = cfg.get("workload", {})
    message_count = int(workload_cfg.get("messageCount", workload_cfg.get("message_count", 1)))
    message_interval = float(workload_cfg.get("messageInterval", workload_cfg.get("message_interval", 0.0)))
